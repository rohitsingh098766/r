...
//                            $following = ' • Following ';
                    ...
                    <div class="grid_mid">
                        <div class="name"><a href="./account?user='.$row['opponent'].'" target="_blank" class="name_link">'.htmlentities($row['first_name'].' '.$row['last_name']).'</a>
                        ...
                        <a href="./account?user='.$row['opponent'].'" target="_blank" class="location"><img class="loc-icon" src="./SVG/location.svg" alt="">'.htmlentities($row['location']).'</a>
                        </div>

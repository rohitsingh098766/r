...
// sidebar open
document.querySelector(".mobile-header .back-icon").addEventListener("click", function () {
...
document.querySelector(".touch-swipe").addEventListener("touchstart", startTouch, false);
document.querySelector(".touch-swipe").addEventListener("touchmove", moveTouch, false);
...
var targets = document.querySelectorAll('.filters-wrapper')
...
var targets2 = document.querySelectorAll('.filters-wrapper .card2')
...
// Show/ hide filters + select filters

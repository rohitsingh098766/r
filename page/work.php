...
$saved_name = $row_show['add_profile_name'];
    ...
    $saved_position = $row_show['position'];
...
if($_POST['degree'] && !$_POST['collage_profile_id']){
...
<body>
        ...
        <div class="main-signup " id="signup-form">
            ...
            <form class="multi-stage" autocomplete="off" id="form" method="post" enctype="multipart/form-data">
                <div class="forms" autocomplete="off" spellcheck="false">
                    ...
                    <span class="note note-plus">What do you do?</span>
                    <div class="input-wrap">
                        <input type="text" class="fields" id="hhh" name="collage"  value="<?php echo $saved_position;?>" required >
                ...
                <div class="forms" autocomplete="off" spellcheck="false">
                    ...
                    <span class="note note-plus">Where do you work? (Optional)</span>
                    <div class="input-wrap">
                ...
                <div class="forms" autocomplete="off" spellcheck="false" id="signup_username">
                    ...
                    <span class="note note-plus">When did you join company?</span>
                    <div class="date-wrap">
                        <div class="input-wrap">
                    ...
                    <span class="note note-plus  "><input type="checkbox" id="i_work_here" onchange="show_ending_date()" checked> I currently work here. </span>
                    <div class="hide hide_a"><span class="note note-plus  ">When did you leave company? </span></div>
                ...
                <div class="forms" autocomplete="off" spellcheck="false">
                    ...
                    <span class="note note-plus">How was your experience at this company? (Optional)</span>
                    <div class="input-wrap">
 ...
 <input type="hidden" name="submitted" value="1">
              ...
              <?php 
            if(isset($_GET['edit'])){
echo '<a href="?delete='.$_GET['edit'].'" id="skipall" >Delete work</a>';
            }
            ?>
        </div>
    </div>

...
$img_out = "./profile/i/none.svg";
    if($row['img']){
       ...
       $img_out = "./profile/i/none.svg";
        ...
        $relation_put = '';
if($row['location']){
    $relation_put = '<div class="location "><img src="./manage_people/image/location.svg" class="location_img"> '.$row['location'].'</div>';
}
